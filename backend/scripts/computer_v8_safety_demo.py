...
def main(lock_path: Path) -> None:
    ...
    print("\nFreshness 人工场景：")
    print("1. observe Notepad，保留 observation_id。")
    print("2. 手动切换到 Calculator。")
    print("3. 批准旧 click/type；预期 Runtime 返回 stale_observation。")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--lock-path",
        type=Path,
        default=Path(".pluto/computer/machine.lock"),
    )
