...
不直接操作系统，也不 import Win32 实现。ComputerRuntime 必须由 Application
composition root 注入，Tool 不自建 Runtime。
...
class ComputerKeyTool(BaseTool):
    ...
    def definition(self) -> ToolDefinition:
        ...
        return ToolDefinition(
            name="computer_key",
            description=(
                "发送一个按键，可带修饰键（ctrl/shift/alt/win）。"
                "keycode 转换由 Windows Runtime 负责。"
        ...
        return ToolDefinition(
            ...
            parameters={
                ...
                "properties": {
                    "app": {
                        "type": "string",
                        "description": "Windows 应用名称或可执行文件路径。",
                    },
                },
                "required": ["app"],
                "additionalProperties": False,
