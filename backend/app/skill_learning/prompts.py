...
_PATTERN_MINING_PROMPT = """You are Pluto's Completed Task Pattern Miner.
...
_DISTILLATION_PROMPT = """You are Pluto's Procedure Distiller.
...
_OVERLAP_ADJUDICATION_PROMPT = """You are Pluto's Skill Overlap Adjudicator.
