/** Live Computer Workspace：Session、Target、Preview 与动作。 */
      ...
      <section className="computer-ready">
        ...
        <div>
          ...
          <p>
            {available
              ? 'Pluto 当前没有控制任何应用。'
              : `${platform === 'windows' ? 'Windows' : '当前'}电脑操作运行时当前不可用。`}
          </p>
        </div>
      </section>
    )
...
export default function ComputerPage(): React.JSX.Element {
  ...
  return (
    <PageShell
      title="电脑"
      subtitle="查看 Windows 桌面控制状态与目标证据。"
      maxWidth={1400}
      actions={
    ...
    >
      <ComputerSessionOverview
        ...
        platform={statusQuery.data?.platform}
      />
      ...
      <section className="computer-runtime">
        <div className="section-heading"><div><h3>运行时</h3><p>Windows 原生控制能力</p></div></div>
        <ComputerStatusView
